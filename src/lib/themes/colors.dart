...
const Color lightGrayButton = Color.fromARGB(255, 131, 135, 146);

Color appBackground = (darkMode ? appDarkBackground : appLightBackground);
const Color appDarkBackground = Color(0xFF181A20);
const Color appLightBackground = Color(0xFFFFFFFF);

const Color studentColor = Color(0xFFFFD551);

const Color leisureColor = Color(0xFFFE505B);

const Color personalColor = Color(0xFFB3FF67);
