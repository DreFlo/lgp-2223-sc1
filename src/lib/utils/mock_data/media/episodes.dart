...
final mockEpisodes = [
  MediaVideoEpisodeSuperEntity(
      ...
      xp: 50,
      participants: 'Dominic West, Lance Reddick, Sonja Sohn, Wendell Pierce, Idris Elba',
      duration: 60,
      number: 1,
      seasonId: 1),
  MediaVideoEpisodeSuperEntity(
