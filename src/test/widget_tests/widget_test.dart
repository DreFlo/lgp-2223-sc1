...
void main() {
  ...
  testWidgets('Edit institution test', (WidgetTester widgetTester) async {
    ...
    container = widgetTester.firstWidget(
        find.byKey(const Key('educationInstitutionType')));
  ...
  testWidgets('Delete institution test', (WidgetTester widgetTester) async {
    ...
    expect(find.byKey(const Key('cancelConfirmationButton')),
        findsOneWidget);
    expect(find.byKey(const Key('deleteConfirmationButton')),
        findsOneWidget);

    await widgetTester
        .tap(find.byKey(const Key('deleteConfirmationButton')));
